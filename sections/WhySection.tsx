const WhySection = () => {
  return (
    <section className="section container">
      ...
      {/* </div> */}
      <p className="bold-p">
        By focusing on one habit at a time, you can lower blood sugar levels,
        improve energy, and reduce long-term health risks.
      </p>
      <p className="bold-p">
        This guide makes it easy and achievable—so you can start seeing results
